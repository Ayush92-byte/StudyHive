...
import com.example.studyhive.presentation.components.SubjectListBottomSheet
import com.example.studyhive.presentation.components.studySessionsList
import com.example.studyhive.util.Constants.ACTION_SERVICE_CANCEL
import com.example.studyhive.util.Constants.ACTION_SERVICE_START
import com.example.studyhive.util.Constants.ACTION_SERVICE_STOP
...
@Destination(
    deepLinks = [
        DeepLink(
            ...
            uriPattern = "study_hive://dashboard/session"
        )
    ]
)
@Composable
